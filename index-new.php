...
WHERE sp_microsite.`client_id` ='" . $c_lient_Id . "' ");
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light">
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto w-100 justify-content-end">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#sp-contact" style="color:<?php echo htmlentities($QrySelectget['headerMenucolor']); ?>;">Contact Me</a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
    ...
    <?php if ($QrySelectget['microsite_aboutme'] == '1' || $QrySelectget['microsite_profilepic'] == '1') { ?>
                    <section <?php if ($QrySelectget['microsite_aboutme'] == '1' || $QrySelectget['microsite_profilepic'] == '1') { ?>style="margin-top:90px;"<?php } ?> id="sp-about" class="sp-about overview-block-ptb <?php echo $newMicro ?>">
                        <div class="container">
                            <div class="row">
    ...
    <?php if ($QrySelectget['microsite_contentlibrary'] == '1') { ?>
        ...
        while ($solutionQget = mysqli_fetch_array($solutionQ)) {
            ...
            $imgcatweb = !empty($solutionQ["web_icon"]) ? 'images/'.$$solutionQ["web_icon"]: 'images/'.$imgstartVal[1] . '-' . $catgIMG.'.png';
            ?>
                                                    <li id="activeShow_<?php echo htmlentities($solutionQget["id"]); ?>" onclick="showcaseproduct(<?php echo htmlentities($solutionQget["id"]); ?>)">

                                                        <a data-toggle="tab" aria-expanded="false" href="javascript:void(0)">
                                                            <img style="padding: 0 25px;" id="solutionimg<?php echo htmlentities($solutionQget["id"]); ?>" src="<?php echo $imgcatweb; ?>" alt="">
    ...
    <?php if ($QrySelectget['microsite_mapflag'] == '1') { ?>
                            <div class="<?php if ($QrySelectget['microsite_getintouch'] == '0') { ?>col-lg-12 <?php } else { ?>col-lg-6 <?php } ?> col-md-12" style="height:711px;">
    ...
    <?php if ($QrySelectget['microsite_getintouch'] == '1') { ?>
                            ...
                            <div class="<?php if ($QrySelectget['microsite_mapflag'] == '0') { ?>col-lg-12 <?php } else { ?>col-lg-6 <?php } ?> col-md-12 align-self-center">
    ...
    <?php
    if ($QrySelectget['microsite_disclaimer'] == 1) {
        ?>
    ...
    <?php } if ($QrySelectget['microsite_footernavigationmenu'] == '1' || $QrySelectget['microsite_footeraboutme'] == '1' || $QrySelectget['microsite_footercontactdetails'] == '1') { ?>
        <div ui-view="footer" class="ng-scope">
            <footer class="dark-bg ng-scope" style="background:<?php echo htmlentities($QrySelectget['footerColor']); ?>;">
                <div class="sp-footer sp-pt-70 sp-pb-20" id='sp-contact1'>
                    <div class="container">
                        <div class="row overview-block-ptb2">
        <?php if ($QrySelectget['microsite_footeraboutme'] == '1') { ?>
        ...
        <?php } if ($QrySelectget['microsite_footernavigationmenu'] == '1') { ?>
                                <div class="<?php if ($QrySelectget['microsite_footercontactdetails'] == '0' || $QrySelectget['microsite_footeraboutme'] == '0') { ?>col-lg-6 <?php } else { ?>col-lg-3<?php } ?> col-md-6 col-sm-6 sp-mtb-20">
                                    <ul class="menu">
        ...
        <?php } if ($QrySelectget['microsite_footercontactdetails'] == '1') { ?>
                                <div class="<?php if ($QrySelectget['microsite_footernavigationmenu'] == '0' || $QrySelectget['microsite_footeraboutme'] == '0') { ?>col-lg-6 <?php } else { ?>col-lg-3<?php } ?> col-md-6 col-sm-6 sp-mtb-20">
                                    <div class="contact-bg">
                                        <ul class="sp-contact">
            <?php if ($QrySelectget['mrc_footerLogo'] != '' && $QrySelectget['microsite_footerLogo'] == '1') { ?>
                                                <li><img src="company_logo/<?php echo htmlentities($QrySelectget['mrc_footerLogo']); ?>" id="logo_img" class="img-fluid" alt=""></li>
                                            <?php } ?>
