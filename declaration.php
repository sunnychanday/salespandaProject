...
if (isset($_POST['action'])) {
    ...
    if ($action == 'flag' && $c_lient_Id != '' && $email != '') {
        ...
        if ($imgName == '') {
            $subdomainqry = mysql_query($q = "update sp_microsite set microsite_address='" . mysql_real_escape_string($microsite_address) . "',
            microsite_address2='" . $microsite_address2 . "',
            microsite_about='" . mysql_real_escape_string($microsite_about) . "'
...
if (isset($_GET['semail']) && $_GET['semail'] != '') {
    ...
    $subdomainqry = mysql_query($q = "select sp_subdomain.client_id,sp_members.person_email,concat(sp_members.first_name,' ',sp_members.last_name) as name,cms_subdomain_url from sp_subdomain left join sp_members on sp_members.client_id=sp_subdomain.client_id where sp_members.person_email like '%" . $email . "%' and sp_subdomain.valid=1 and sp_subdomain.deleted=0 and sp_subdomain.status=1");
    $countmicrosite = mysql_num_rows($subdomainqry);
...
$ButsubSection = '';
if (@$QrySelectget['new_site_flag'] == 1) {
    $subSection = "hidden";
} else {
    $ButsubSection = "hidden";
}
?>
                ...
                <div class="row" style="width:100%;">
                    <div class="col-6">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <img src="img/hdfcmf-logo.png"  class="img-fluid" alt="" style="width:150px;">

                        </nav>
                    </div>
                    <div class="col-6">
                        <img src="img/mf-online-logo.png"  class="img-fluid float-right" alt="" style="width:150px;">
                ...
                <div class="container" >
                    ...
                    <div class="row <?php echo $display; ?>" style="margin-top:30px!important;" >
                        <div class="col-lg-6 col-md-12">
                            <div class="col-sm-12">
                                <p style="color:#103880; text-align:center;"><?php
echo $msg;
if ($newMicroSite != '') {
...
?> </p>
                                <div id="topSection" class="<?php echo $subSection; ?>">
                                    ...
                                    <p style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, 'sans-serif'; font-size: 15px; line-height: 23px; padding-top: 40px;">An investor would like to know itâ€™s distributor before buying anything from them. Write something about yourself in this section and let your investors know about you.</p>
                                    <div class="col-sm-12" style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, 'sans-serif'; font-size: 16px; font-weight: bold; color: #58595b; background-color:#e3e3e3; line-height:2;">
                                ...
                                <div class="<?php echo $ButsubSection; ?>" id="bottomSection">
                                    ...
                                    <div><p style="font-size:18px;" class=""><strong>Congrats <?php echo $name; ?>! Itâ€™s almost done.</strong></p>
                                        <strong>Please fill the below details to personalise your Business Website.</strong></div>
...
if ($crop_image != '') {
    ?>
                                                        ...
                                                        <img id='base64image' height="200" width="200" src="images/<?php echo $crop_image; ?>" />
<?php } else { ?>
                                                        <input id="sample_input" type="hidden" title="Upload Photo" name="profile_image">
                                                        <img src="manager/images/no-image-available.gif" height="200" width="200" border="0" />
    <?php }
?>								  
                                                </div>
                        ...
                        <div  class="col-lg-6 col-md-12">
                            <img src="https://resources.mutualfundpartner.com/img/microsite-view.jpg" style="width:100%" alt="">
                        </div>
                    </div>
    ...
    <div class="modal-dialog" style="width:60%!important;">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <p>These terms and conditions (â€œ<strong>Terms</strong>â€?) are applicable to "<strong><?php echo $name; ?></strong>" having its address at "<?php echo (@$micrositeData['microsite_address'] == '') ? "___________" : $micrositeData['microsite_address']; ?>" (hereinafter referred to as the â€œ<strong>Distributor</strong>â€?, which expression shall unless repugnant to the context and meaning thereof be deemed to mean and include its administrators and permitted assigns) that access, use or browse "<strong><?php echo ($cms_subdomain_url == '') ? "___________" : $cms_subdomain_url; ?>"</strong>  for Distributors (also referred to as â€œMicrositeâ€?) and associated websites, webpages, online properties, tools, and weblinks provided for digital marketing solution via web and app (collectively, the â€œPortalâ€?). 
                </p><p>In favor of:
                </p><p>Bizight Solutions Private Limited, incorporated under the Companies Act, 1956 having its corporate office at 105, Chiranjiv Towers, 43, Nehru Place, Delhi -110019 and registered office at A3, FF, S-515, Greater Kailash II, New Delhi, Delhi â€“ 110048 hereinafter referred to as â€œ<strong>Bizight</strong>â€? (which term shall unless the content otherwise provides include its successors and permitted assigns) 
                ...
                </p><p>1.1	The Distributor hereby confirms that it has voluntarily accessed the Portal and hereby agrees to the use of the same in accordance with these Terms. The Distributor understands and confirms that by (i) ticking/clicking the â€œI agreeâ€? or similar icon/tab/checkbox on the online system/Portal or on a URL/ weblink; as well as by (ii) entering the one time password sent by Bizight to the Distributor, the Distributor has given its acceptance of these Terms and it is bound by the Terms hereof. 

                </p><p><strong>2.	Services </strong>
                </p><p>2.1	Bizight owns, maintains and operates the Portal for the purpose of use and access of the Distributor(s) that are empaneled and registered with HDFC Mutual Fund (â€œHDFC MFâ€? or â€œMFâ€?)/HDFC Asset Management Company Limited (â€œHDFC AMCâ€? or â€œAMCâ€?) and its Investors (defined hereinafter).
