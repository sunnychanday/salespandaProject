...
$_COOKIE["uemail"];
//$_SERVER['HTTP_HOST'] = 'http://localhost/sp-icici/Richa.spdevchannels.com';
if (empty($c_lient_Id)) {
...
if ($countmicrosite > 0) {
   ...
   $stmt = $connPDO->prepare("SELECT *
           FROM sp_microsite_slider WHERE users_category='".$pc_member_info['c_client_id']."'
           ");
   $stmt->execute();
   $datas =$stmt->fetchAll();
    // print_r($datas);
    ...
    if ($pcmember_pc_type == 'C') {
        ...
        $sqry = "select id,cms_subdomain_url from sp_subdomain where client_id='" . $c_lient_Id . "'";
...
.carousel-item h6 a {
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light">
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto w-100 justify-content-end">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#sp-about" style="color:<?php echo htmlentities($QrySelectget['headerMenucolor']); ?>;" >About Us</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#sp-blog" style="color:<?php echo htmlentities($QrySelectget['headerMenucolor']); ?>;">Content</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#sp-contact" style="color:<?php echo htmlentities($QrySelectget['headerMenucolor']); ?>;">Contact</a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
                ...
                <div class="carousel slide" id="myCarousel" data-ride="carousel">
                         <div class="carousel-inner">
                            ...
                            <div class="carousel-item <?php echo $key == 0 ? 'active' : '';?>">
                                ...
                                <h2><?php echo htmlentities($value['slider_headline']); ?></h2>
                            </div>
                              <img src="company_banner/<?php echo htmlentities($value['slider_img']); ?>" alt="Los Angeles" width="1100" height="500">
                              <h6><a href="<?php echo htmlentities($value['slider_link']); ?>"><?php echo htmlentities($value['slider_para']); ?></a></h6>
                            </div>
                        <?php }?>
                          </div>
  ...
  <a class="carousel-control-next" href="#myCarousel" data-slide="next">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-md-12 align-self-start">
                                ...
                                <a class="button sp-mt-15" href="#sp-contact" style="background:#6A4742;">Contact Me</a>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="heading-title">
                                    ...
                                    <h5 class="title sp-tw-6 sp-font-green">View our solutions below.</h5>

                                    <h6>Whether its for your wealth, your family's future, or even your retirement, we have just the right plans to help you achieve your goals!</h6>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <ul class="nav nav-tabs">
                                            ...
                                            while ($solutionQget = mysqli_fetch_array($solutionQ)) {
                                                ...
                                                <li id="activeShow_<?php echo htmlentities($solutionQget["id"]); ?>" onclick="showcaseproduct(<?php echo htmlentities($solutionQget["id"]); ?>)">
                                                    ...
                                                    <a data-toggle="tab" aria-expanded="false" href="javascript:void(0)">
                                                        <img style="padding: 0 25px;" id="solutionimg<?php echo htmlentities($solutionQget["id"]); ?>" src="images/icon0<?php echo $i; ?>.png" alt="">
                                                        <img class="activeimg" src="images/icon0<?php echo $i; ?>.png" style="padding: 0 25px;display:none;"> 
                            ...
                            <div class="sp-mlr-60 sp-ptb-80">
                                ...
                                <form id="contact" method="post" class="ng-pristine ng-valid">
                                    <div class="contact-form">
                                        ...
                                        <button name="submit" type="submit" value="Send" style="background:#6A4742;" onclick="return submit_formbuilder();" id="send-value" class="button sp-mt-15">Send Message</button>
    ...
    <div ui-view="footer" class="ng-scope hidden">
        <footer class="dark-bg ng-scope" style="background:#201E19;">
    ...
    $baseUrl = url();
    if (strstr($baseUrl, 'mutualfundpartner.com') == true) {
        $blue = "#45bcd4";
        $text_color = "#4E4E4E";
        $chat_1 = "#eaf0f6";
        $chat_2 = "#f2f2f2";
